...
<html lang="en">
  ...
  <body>
    ...
    <div id="container" class="small">
        ...
        <br>
        <div class="col-2" style="background:#EAFFDE">
        ...
        <br>
        <div class ="col-2" style="background:#FEDEDE">
        ...
        <br>
        <div class ="col-2" style="background:#E6A9A9">
          <div>
            <?php if ($sex == "male") : ?>
        ...
        <br>
        <div class="col-2" style="background:#F4BB38">
        ...
        <div class="col-2"style="background:#E6A9A9">
          <table>
            <tr>
              <td><span style="font-weight:bold">MED:</span></td><td>1</td>
            </tr>
              <tr>
              <td><span style="font-weight:bold">TEST - A:</span></td><td>2</td>
            </tr>
              <tr>
              <td><span style="font-weight:bold">TEST - B:</span></td><td>3</td>
            </tr>
              <tr>
              <td><span style="font-weight:bold">MED:</span></td><td>4</td>
            </tr>
              <tr>
              <td><span style="font-weight:bold"> GYNE:</span></td><td>5</td>
            </tr>
              <tr>
              <td><span style="font-weight:bold">TEST - A:</span></td><td>6</td>
            </tr>
              <tr>
              <td><span style="font-weight:bold">GYNE:</span></td><td>7</td>
            </tr>
              <tr>
              <td><span style="font-weight:bold">DENT:</span></td><td>8</td>
            </tr>
              <tr>
              <td><span style="font-weight:bold">EYE:</span></td><td>9</td>
            </tr>
              <tr>
              <td><span style="font-weight:bold">EDUC:</span></td><td>10</td>
            </tr>
              <tr>
              <td><span style="font-weight:bold">RXY:</span></td><td>11</td>
            </tr>
